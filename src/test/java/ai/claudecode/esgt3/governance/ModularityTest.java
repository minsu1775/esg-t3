 ...
 * esg-t3는 핵심 8개 모듈 + Phase 0 임시 observability 모듈.
 */
class ModularityTest {
    ...
    @Test
    @DisplayName("모듈 9개가 등록된다")
    void 모듈_9개가_등록된다() {
        // iam, entity, audit, ghg, evidence, vw, rpt, shared, observability(Phase 0 임시)
        assertThat(MODULES.stream().count()).isEqualTo(9L);
    }
